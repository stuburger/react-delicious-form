...
function default_1(_a) {
    ...
    var createTrackedFormFields = function (props) {
        ...
        lodash_1.forOwn(fieldDefinitions, function (v, k, a) {
            if (v.computed && v.computed.read) {
                var readResult = v.computed.read(trackedFields);
    ...
    var set = function (allFields, fieldName, value) {
        ...
        var setValues = function (fName, val) {
            ...
            if (computed && computed.write) {
                var writeResult_1 = computed.write(val);
            ...
            lodash_1.forOwn(fieldDefinitions, function (v, k, a) {
                if (v.computed && v.computed.read) {
                    var readResult = v.computed.read(fields);
            ...
            function Enhance(props) {
                ...
                _this.updateField = function (fieldName, value) {
                    ...
                    return _this.setState({
                        fields: set(_this.state.fields, fieldName, value),
                ...
                _this.submit = function (context) {
                    ...
                    return onSubmit(getFormItem(fields), _this.props, context);
                };
