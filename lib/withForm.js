...
function default_1(_a) {
    ...
    var checkFormIsValid = function (fields, props) {
        return lodash_1.every(fieldDefinitions, function (field, key) {
            var validators = unwrap(field.validators, props);
            return lodash_1.every(validators, (function (test) { return test(fields[key], fields, props).isValid; }));
        });
    };
    ...
    return function (Child) {
        return (function (_super) {
            ...
            Form.prototype.shouldFormSubmit = function () {
                return checkFormIsValid(this.state.fields, this.props);
            };
            Form.prototype.render = function () {
                var _this = this;
                var _a = this.state, fields = _a.fields, formStatus = _a.formStatus;
                return (React.createElement(Child, __assign({}, this.props, { fields: lodash_1.transform(fields, function (ret, field, key) {
                        var validationResult = _this.getFieldValidationResult(fieldDefinitions[key], field);
                        ret[key] = __assign({}, field, validationResult, unwrap(fieldDefinitions[key].props, _this.props), { showMessages: !validationResult.isValid && field.didBlur, isDirty: field.originalValue !== field.value, onChange: function (value) {
                                _this.updateField(key, value);
                            }, onFieldBlur: function () {
                                var field = lodash_1.cloneDeep(fields[key]);
                                field.didBlur = true;
                                _this.setState({ fields: __assign({}, fields, (_a = {}, _a[key] = field, _a)) });
                                var _a;
                            } });
                    }), submit: this.submit, formStatus: formStatus, updateField: this.updateField, formIsValid: this.shouldFormSubmit() })));
            };
            return Form;
        }(React.Component));
    };
